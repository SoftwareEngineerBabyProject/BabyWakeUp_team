package com.example.wenyu.baby.database;
...
public class Database extends SQLiteOpenHelper {
	...
	public static final String COLUMN_ALARM_PATH = "alarm_path";
	public static final String COLUMN_ALARM_DIFFICULTY = "alarm_difficulty";
	public static final String COLUMN_GIRLS_ID = "girls_id";
	...
	public static long create(Alarm alarm) {
		...
		cv.put(COLUMN_ALARM_PATH, alarm.getAlarmPhotoPath());
		cv.put(COLUMN_GIRLS_ID, alarm.getGirlsID());
	...
	public static int update(Alarm alarm) {
		...
		cv.put(COLUMN_ALARM_VIBRATE, alarm.getVibrate());
		cv.put(COLUMN_ALARM_DIFFICULTY, alarm.getDifficulty().ordinal());
		cv.put(COLUMN_ALARM_TONE, alarm.getAlarmPhotoPath());
		cv.put(COLUMN_GIRLS_ID, alarm.getGirlsID());
	...
	public static Alarm getAlarm(int id) {
		...
		if(c.moveToFirst()){
			...
			alarm.setDifficulty(Alarm.Difficulty.values()[c.getInt(7)]);
			alarm.setAlarmTonePath(c.getString(8));
			alarm.setGirlsID(c.getInt(9));
		}
		c.close();
		return alarm;
	}
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( "
				...
				+ COLUMN_ALARM_TONE + " TEXT NULL, "
				+ COLUMN_ALARM_VIBRATE + " INTEGER NOT NULL,"
				+ COLUMN_ALARM_DIFFICULTY + " INTEGER NOT NULL,"
				+ COLUMN_ALARM_PATH + " TEXT NULL,"
				+ COLUMN_GIRLS_ID + " INTEGER NULL) ");
	}
	...
	public static List<Alarm> getAll() {
		...
		if (cursor.moveToFirst()) {
			...
			do {
				...
				alarm.setDifficulty(Alarm.Difficulty.values()[cursor.getInt(6)]);
				alarm.setAlarmPhotoPath(cursor.getString(7));
				alarm.setGirlsID(cursor.getInt(8));
